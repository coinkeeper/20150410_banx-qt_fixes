...
void OptionsDialog::setModel(OptionsModel *model)
{
    ...
    /* update the display unit, to not use the default ("BANX") */
    updateDisplayUnit();
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting BANX."), QMessageBox::Ok);
