    ...
    rpcConsole(0)
{
    ...
    resize(850, 550);
    setWindowTitle(tr("BANX") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    centralWidget->addWidget(transactionsPage);
        transactionsPage->setStyleSheet("background-color: white");
    transactionsPage->setStyleSheet("background: white");
    centralWidget->addWidget(addressBookPage);
        addressBookPage->setStyleSheet("background-color: black");
    addressBookPage->setStyleSheet("background: white");
    centralWidget->addWidget(receiveCoinsPage);
        receiveCoinsPage->setStyleSheet("background-color: white");
    receiveCoinsPage->setStyleSheet("background: white");
    centralWidget->addWidget(sendCoinsPage);
        sendCoinsPage->setStyleSheet("background-color: white");
    sendCoinsPage->setStyleSheet("background: white");
...
void BitcoinGUI::createActions()
{
	...
	*/
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BANX address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About BANX"), this);
    aboutAction->setStatusTip(tr("Show information about BANX"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BANX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BANX addresses to prove you own them"));

    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BANX addresses"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BANX client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BANX client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BANX network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BANX address or malformed URI parameters."),
...
void BitcoinGUI::openBittrex() {
    QDesktopServices::openUrl(QUrl("https://bittrex.com/Market/Index?MarketName=BTC-BANX"));
}

void BitcoinGUI::openHome() {
    QDesktopServices::openUrl(QUrl("http://BANX.io/"));
}

void BitcoinGUI::openWiki() {
    QDesktopServices::openUrl(QUrl("http://BANXcrypto.com/wiki/index.php/Main_Page"));
}