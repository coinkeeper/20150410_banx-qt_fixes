    ...
    filter(0)
{
    ...
    if(GetBoolArg("-chart", true))
    {
        ...
        // set the pens
        ui->diffplot->graph(0)->setPen(QPen(Qt::black));

        ui->diffplot->xAxis->setTickLabelColor(Qt::black);
        ui->diffplot->xAxis->setBasePen(QPen(Qt::black));
        ui->diffplot->xAxis->setLabelColor(Qt::black);
        ui->diffplot->xAxis->setTickPen(QPen(Qt::black));
        ui->diffplot->xAxis->setSubTickPen(QPen(Qt::black));
        ui->diffplot->yAxis->setTickLabelColor(Qt::black);
        ui->diffplot->yAxis->setBasePen(QPen(Qt::black));
        ui->diffplot->yAxis->setLabelColor(Qt::black);
        ui->diffplot->yAxis->setTickPen(QPen(Qt::black));
        ui->diffplot->yAxis->setSubTickPen(QPen(Qt::black));
        ui->diffplot->yAxis->grid()->setPen(QPen(QColor(Qt::black), 1, Qt::DotLine));		
        ui->diffplot->xAxis->grid()->setPen(QPen(QColor(Qt::black), 1, Qt::DotLine));
